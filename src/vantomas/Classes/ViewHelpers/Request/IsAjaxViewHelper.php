...
class IsAjaxViewHelper extends AbstractViewHelper {
	...
	/**
	 * Flags if the request is done be the expected host
	 *
	 * @return boolean
	 */
	...
	/**
	 * Flags if the HTTP_X_REQUESTED_WITH header is set and has the expected value
	 *
	 * @return boolean
	 */
