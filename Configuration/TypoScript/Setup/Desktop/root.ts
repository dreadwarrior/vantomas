...
page {
  ...
  includeJSlibs {
    /*
    google_api = http://www.google.com/jsapi?key={$site.google.apikey}
    google_api.external = 1
    */
    ...
    hr_dates = https://raw.github.com/zachleat/Humane-Dates/master/src/humane.js
    hr_dates.external = 1
    hr_dates.disableCompression = 1
  }

  includeJS {
    #ie7 = fileadmin/templates/{$site.template_path}/js/ie7/ie7-standard-p.js
    #ie7.allWrap = <!--[if lte IE 7]>|<![endif]-->
  }

  includeJSFooter {
    //lazy_load = fileadmin/templates/{$site.template_path}/js/jquery.lazyload.mini.js
    github_projects = fileadmin/templates/{$site.template_path}/js/github_projects.js
    content_height = fileadmin/templates/{$site.template_path}/js/content_height.js
  }
  ...
  includeCSS {
    google_fonts = http://fonts.googleapis.com/css?family=Neuton|Yanone+Kaffeesatz|Lobster
    google_fonts.external = 1

    style_min = fileadmin/templates/{$site.template_path}/css/style_screen_min.css.gz
    style_min {
      media = screen, projection
      title = Standard
    }
    print = fileadmin/templates/{$site.template_path}/css/style-print.css
    print {
      media = print
      title = Standard
    }
    #calendar_date_select = fileadmin/templates/{$site.template_path}/css/calendar_date_select/profi.css

    #ieall = fileadmin/templates/{$site.template_path}/css/style-ie.css
    #ieall.allWrap = <!--[if lte IE 7]>|<![endif]-->
    #ie6 = fileadmin/templates/{$site.template_path}/css/style-ie6.css
    #ie6.allWrap = <!--[if IE 6]>|<![endif]-->
  }
  ...
  headerData {
    ...
    # Favicon
    19 = TEXT
    19.value = <link rel="icon" type="image/x-icon" href="fileadmin/templates/{$site.template_path}/img/favicon.ico" />
  }
